<div class="form-group row">
  <div class="col-lg-3">
    ...
    {!! Form::number('context_1_title', (isset($data->context_1_title) ? $data->context_1_title : ''), ['class' => $errors->has('context_1_title') ? 'form-control is-invalid' : 'form-control', 'required' => 'required', 'placeholder' => 'Enter Number Context 1']) !!}
    <span class="form-text text-muted"> Please enter number context 1 title </span>
  </div>
  <div class="col-lg-3">
    <label> Context 2 Title </label>
    {!! Form::number('context_2_title', (isset($data->context_2_title) ? $data->context_2_title : ''), ['class' => $errors->has('context_2_title') ? 'form-control is-invalid' : 'form-control', 'required' => 'required', 'placeholder' => 'Enter Number Context 2']) !!}
    <span class="form-text text-muted"> Please enter number context 1 title </span>
  </div>
  <div class="col-lg-3">
    <label> Context 3 Title </label>
    {!! Form::number('context_3_title', (isset($data->context_3_title) ? $data->context_3_title : ''), ['class' => $errors->has('context_3_title') ? 'form-control is-invalid' : 'form-control', 'required' => 'required', 'placeholder' => 'Enter Number Context 3']) !!}
    <span class="form-text text-muted"> Please enter number context 1 title </span>
  </div>
  <div class="col-lg-3">
    <label> Context 4 Title </label>
    {!! Form::number('context_4', (isset($data->context_4_title) ? $data->context_4_title : ''), ['class' => $errors->has('context_4_title') ? 'form-control is-invalid' : 'form-control', 'required' => 'required', 'placeholder' => 'Enter Number Context 4']) !!}
